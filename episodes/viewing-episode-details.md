---
description: A tour of the episode detail page in RTMLink — the patient summary, current 30-day window progress, survey settings, responses, time tracking, and billing status.
---
...
Further down, additional sections list the episode's **appointments**, **billing suggestions**, **exercise assignments**, and the full history of **billing windows**.
