---
description: "Everyday episode actions in RTMLink: copying a patient's survey link, messaging the patient, and editing episode settings like provider, survey, and schedule."
---
...
- Or open the episode and copy it from the **Survey Link** field in **Survey Settings**.

> The **Survey Link** action appears only on **active** episodes that have a survey link set up.
...
- **Assigned Provider**
- **Survey**, **Frequency**, and **Send Time** (see [How often surveys are sent](enrolling-a-patient.md#how-often-surveys-are-sent) for all frequency options)
- **Communication Methods** (SMS / Email)
- **Clinical Context**: diagnosis code, diagnosis description, ICD-10 codes, body part, treatment type, and a custom **Episode Name**
- **Notes**
