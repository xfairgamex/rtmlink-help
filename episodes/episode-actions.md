...
Beyond changing an episode's status, there are a few day-to-day actions you'll use often: sharing the patient's survey link, messaging them, and editing the episode's settings. Most are on the **Episodes** list — open the actions menu on the episode's row (the **⋯** button) — and the main ones are also available when you open an episode.
