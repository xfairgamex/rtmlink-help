---
description: "A tour of the Messages inbox in RTMLink: the conversation list, unread indicators, search, and how the two-pane layout keeps patient texting and email in one place."
---
...
![The Messages inbox: conversations on the left with unread indicators, the open thread on the right.](../.gitbook/assets/messaging/messages-inbox.png)
