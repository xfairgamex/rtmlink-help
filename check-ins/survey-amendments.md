...
An **amendment** is a patient's correction to a check-in they already submitted. Maybe they tapped the wrong pain number or answered before re-reading the question. Amendments let them fix it while RTMLink keeps a complete, accurate record.

## How a patient amends a response
...
> **Why keep both?** Remote Therapeutic Monitoring is a billable medical service, so the record needs to be trustworthy. Retaining the original alongside the correction means the patient can fix genuine mistakes without erasing what was first reported.
