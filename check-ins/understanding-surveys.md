...
A survey is a list of **questions**. Each question has a type (a 0 to 10 scale, yes/no, multiple choice, a number, or free text) and can be configured to:
...
| **Patient-Facing Name** | What patients see (empty if none set). |
