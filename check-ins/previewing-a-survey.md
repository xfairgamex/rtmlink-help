...
Click **Preview Survey** from any of these places:

- The actions menu on a survey's row in **Check-In Templates**.
- The top of a survey when you're **viewing** it.
- The top of the survey while you're **editing** it.

The preview opens in a **new tab**, so you can keep editing in the original tab and refresh the preview to check your changes.
...
The preview is for **signed-in clinic staff**. It is not the patient's survey link. Patients receive their own personal link by SMS or email, which opens their actual check-in, auto-saves their answers, and records a response. See [Understanding survey responses](understanding-survey-responses.md) for the patient's side.
