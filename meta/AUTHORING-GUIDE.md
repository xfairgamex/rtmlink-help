...
| **Time Tracking** | `app/Livewire/Clinic/Episodes/TimeEntriesTable.php`, `TimeTrackingWidget.php` (its Log Time Entry modal is also the interactive-contact logging path), `app/Models/TimeEntry.php` |
