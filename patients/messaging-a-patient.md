---
description: How to text or email a patient directly from their record or the patient list, why available channels depend on consent, how to schedule a message, and how to read delivery status.
---
...
Open the messaging panel in either place:
...
1. Switch on **schedule** mode in the composer.
2. Pick the date and time to send (in your clinic's timezone).
3. Confirm.

A scheduled message shows in the conversation as upcoming. Before it sends, you can **edit** it, **cancel** it, or **send it now**.
