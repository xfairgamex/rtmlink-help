...
| **Category** | The body area or type, shown as a badge. |
...
**Exercise Details**
- **Name** (required).
- **Category** — the body area or type. Your clinic's list typically includes Shoulder, Knee, Hip, Spine, Core, Ankle/Foot, Wrist/Hand, Elbow, Neck, and General (your clinic may use a custom set).

> Starting from something similar? Use **Copy details from exercise** to pull in another exercise's name, instructions, and default prescription. Media is never copied — add this exercise's own images and video.
