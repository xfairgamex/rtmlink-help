...
|--------|---------------|
| **Pending** | The upload is queued. |
| **Processing** | RTMLink is preparing the video for playback. |
| **Ready** | The video is ready for patients and for the thumbnail and preview tools. |
| **Error** | Something went wrong with the upload; try uploading it again. |
